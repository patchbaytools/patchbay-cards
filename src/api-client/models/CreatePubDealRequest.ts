...
/* tslint:disable */
/* eslint-disable */
import type { CreatePubDealContactRequest } from './CreatePubDealContactRequest';
...
export type CreatePubDealRequest = {
    status?: DealStatus;
    active?: (boolean | null);
    ...
    publishing_contact?: (CreatePubDealContactRequest | null);
};
