...
export default function CardPageContent({ data, id }: { data: CardData, id: string }) {
  ...
  return (
    <div ref={containerRef} className="h-screen overflow-auto snap-y snap-mandatory hide-scrollbar">
