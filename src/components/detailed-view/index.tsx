    ...
    <div className="container mx-auto px-4 py-16">
      ...
      >
        <motion.div variants={cardVariants}>
          <h1 className="text-4xl font-bold mb-6 text-gray-900 dark:text-gray-100">{data.name || "Paul McCartney"}</h1>
          <p className="text-xl mb-8 text-gray-700 dark:text-gray-300">{data.title || "Artist, Producer, Songwriter • BMI"}</p>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300">{data.metadata?.upc || "602567924128"}</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 text-gray-800 dark:text-gray-200">Performing Rights</h3>
              <p className="text-gray-700 dark:text-gray-300">{data.metadata?.rights || "BMI"}</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 text-gray-800 dark:text-gray-200">Publisher</h3>
              <p className="text-gray-700 dark:text-gray-300">{data.metadata?.publisher || "MPL Communications"}</p>
            </div>
          </div>
        </motion.div>
        <motion.div 
